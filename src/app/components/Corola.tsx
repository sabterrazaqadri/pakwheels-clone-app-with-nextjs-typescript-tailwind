...
export default function Corola() {
  return (
    <div className="w-full h-auto flex justify-center">
      <div className=" w-2/4 h-full justify-center ">
        <div className=" flex justify-center mt-8">
          <h1 className="underline text-2xl font-bold">Toyota Corolla 2024 Price In Pakistan,Images,Reviews & Specs</h1>
        </div>
        <div className="flex justify-center mt-6">
          <Image src={i2} alt="img" className="w-60"></Image>
              </div>
              ...
              <div className="flex justify-center mt-6 gap-6">
                  ...
                  <h6 className="text-xs"><b>Engine : </b>1600cc</h6>
                  <h6 className="text-xs"><b>Condition : </b>9/10</h6>
                  <h6 className="text-xs"><b>Driven : </b>13500 KM</h6>
              </div>

              <div className="flex justify-center mt-4 gap-4">
              <h6 className="text-xs"><b>Suspension Type : </b>Soft Suspension</h6>
                  <h6 className="text-xs"><b>Fuel Average : </b>15 KM Per Ltr</h6>
                  <h6 className="text-xs"><b>Transmision Type : </b>Manual</h6>
                  <h6 className="text-xs"><b>Fuel Type : </b>High Octane</h6>
              </div>

              <div className="flex justify-center mt-8 font-semibold">
                  <h1 className="text-green-600">PKR 85,50,000</h1>
              </div>          
